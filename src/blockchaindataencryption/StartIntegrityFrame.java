 ...
 * @author welcome
 */
public class StartIntegrityFrame extends javax.swing.JFrame {

    /**
     * Creates new form UserOperationFrame
     */
    public StartIntegrityFrame() {
        
        super("START INTEGRITY FRAME");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Integrity Violation Report");

        jButton2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jButton2.setText("Stop Integrity Engine");
        ...
        jPanel1.setBounds(379, 30, 643, 601);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/blockchaindataencryption/block.jpeg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
           ...
           ArrayList fileinfo=new UploadFileDataExtractor().getUploadFileData();
           
           ArrayList sortedfileinfo=new Sorter().getSortedList(fileinfo);
           
           IntegrityEngine ie=new IntegrityEngine();
           ie.setFileInfo(sortedfileinfo);        
           ie.start();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StartIntegrityFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StartIntegrityFrame().setVisible(true);
            }
        });
    }
