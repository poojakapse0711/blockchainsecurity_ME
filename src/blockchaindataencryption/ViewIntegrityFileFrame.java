 ...
 * @author welcome
 */
public class ViewIntegrityFileFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewUploadFileFrame
     */
    public ViewIntegrityFileFrame() {
        
        super ("VIEW INTEGRITY FILE FRAME");
        initComponents();
        
        IntegrityFileDataExtractor ue=new IntegrityFileDataExtractor();
        
        ArrayList filedata=ue.getIntegrityFileData();
...
//         
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewIntegrityFileFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewIntegrityFileFrame().setVisible(true);
            }
        });
    }
