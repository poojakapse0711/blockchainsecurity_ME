 ...
 * @author welcome
 */
public class ViewSearchFileFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewUploadFileFrame
     */
    public ViewSearchFileFrame() {
        
        super ("VIEW SEARCH FILE FRAME");
        initComponents();
        
        SearchFileDataExtractor se=new SearchFileDataExtractor();
        
        String uid=LoginFrame.userid;
        ArrayList filedata=se.getSearchFileData(uid);
        ...
        Object rowData[] = new Object[3];
         ...
         for(int i=0;i<filedata.size();i++)
         {
             ...
             ArrayList temp=(ArrayList) filedata.get(i);
...
//          System.out.println(str);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date and Time", "Keyword", "File Name"
            }
        ) {
        ...
        jScrollPane1.setBounds(260, 160, 950, 280);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewSearchFileFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewSearchFileFrame().setVisible(true);
            }
        });
    }
