 ...
 * @author welcome
 */
public class ViewUploadFileFrame extends javax.swing.JFrame {

    /**
     * Creates new form ViewUploadFileFrame
     */
    public ViewUploadFileFrame() {
        
        super ("VIEW UPLOAD FILE");
        initComponents();
        
        UploadFileDataExtractor ue=new UploadFileDataExtractor();
        
        ArrayList filedata=ue.getUploadFileData();
...
//         
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr. No", "File Name", "Head Key", "Date Time"
            }
        ) {
        ...
        jScrollPane1.setBounds(250, 220, 950, 280);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUploadFileFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewUploadFileFrame().setVisible(true);
            }
        });
    }
